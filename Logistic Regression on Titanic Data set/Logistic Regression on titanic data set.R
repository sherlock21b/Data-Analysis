library(readr)
titanic <- read_csv("C:/Users/Admin/Downloads/Compressed/train.csv")
...
#the graph makes it known that the threshold should be 0.2


#for finding the accuracy we need to construct a confused matrix
t<-table(ActualValue=testing$Survived,PredictedValue=res>0.2)
(123+56)/(123+11+56+32)
#the accuracy is 80% which is quite good 
